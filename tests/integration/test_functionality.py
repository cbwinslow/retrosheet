...
class TestConcurrency:
    ...
    def test_parallel_feature_computation(self):
        ...
        states = [GameState(inning=i, is_top=(i % 2 == 1), outs=0) for i in range(1, 10)]
    ...
    def test_cache_consistency(self):
        ...
        results = [
            calc.compute_from_cache(GameState(inning=1, is_top=True, outs=0)) for _ in range(100)
        ]
...
class TestPerformance:
    ...
    def test_memory_usage(self):
        ...
        calc = WinExpectancyCalculator(db_connection=None)
        calc._we_matrix = {
            (i, j, k, '000', 0): 0.5 for i in range(1, 10) for j in [True, False] for k in range(3)
        }
...
class TestMonitoring:
    ...
    def test_benchmark_logging(self):
        ...
        from baseball.core.benchmark import BenchmarkLogger, benchmark
...
class TestDocumentation:
    ...
    def test_docstrings_present(self):
        ...
        from baseball.features.base import FeatureConfig, FeatureStore, GameState
