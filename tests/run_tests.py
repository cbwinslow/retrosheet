...
class TestRunner:
    ...
    def run_unit_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = [
            ...
            "--tb=short",
            "--json-report",
            "--json-report-file", str(self.output_dir / "unit_tests.json"),
        ]
    ...
    def run_integration_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = [
            ...
            "--tb=short",
            "--json-report",
            "--json-report-file", str(self.output_dir / "integration_tests.json"),
        ]
    ...
    def run_e2e_tests(self, verbose: bool = False) -> Dict[str, Any]:
        ...
        cmd = [
            ...
            "--tb=short",
            "--json-report",
            "--json-report-file", str(self.output_dir / "e2e_tests.json"),
        ]
        cmd = [c for c in cmd if c]
    ...
    def generate_report(self) -> None:
        ...
        total_duration = sum(s.get("duration_seconds", 0) for s in self.results["test_suites"].values())
    ...
    def run_all(self, unit: bool = True, integration: bool = True, 
                e2e: bool = True, benchmarks: bool = False, 
