...
class TestScriptSyntax:
    ...
    def test_shell_script_syntax(self):
        ...
        if errors:
            pytest.fail('Shell syntax errors:\n' + '\n'.join(errors))
    ...
    def test_python_scripts_syntax(self):
        ...
        for script in py_scripts:
            if script.name.startswith('.') or any(
                script.name.startswith(e) or script.name == e for e in excluded
            ):
                continue
        ...
        if errors:
            pytest.fail('Python syntax errors:\n' + '\n'.join(errors))
