...
from baseball.features.base import GameState, FeatureConfig
...
class TestLeverageIndexCalculator:
    ...
    def test_li_scale_reference(self, mock_db):
        ...
        assert calc.compute(GameState(inning=9, is_top=False, outs=2,
                                      runner_1b=True, runner_2b=True, runner_3b=True)) == 3.5
