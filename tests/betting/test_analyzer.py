...
from baseball.betting.analyzer import (
    BettingAnalyzer, standard_edge_calculator, kelly_edge_calculator
)
from baseball.betting.schemas import (
    BettingMarket, BetOpportunity, MarketType, Sport, BookRegion, MarketStatus
)
...
class TestDelegateFunctions:
    ...
    def test_custom_edge_calculator(self):
        ...
        custom_calc = lambda p, o: (p * Decimal("2")) - Decimal("1")
