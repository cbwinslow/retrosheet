...
- Track issues in GitHub repository (https://github.com/cbwinslow/retrosheet/issues)
- Link each issue to the relevant documentation section.
- Review and close issues as work is completed.
- **Model Training Pipeline**: Hyper‑parameter sweep for `pa_batter_hit` completed; see [#55](https://github.com/cbwinslow/retrosheet/issues/55).
