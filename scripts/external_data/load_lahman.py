...
TABLES = {
    ...
    "Teams.csv": (
        ...
        [
            ...
            "DivWin","WCWin","LgWin","WSWin","R","AB","H","_2B","_3B","HR","BB",
            "SO","SB","CS","HBP","SF","RA","ER","ERA","CG","SHO","SV","IPouts",
            "HAA","HA","BAA","OAA","OBA","leagueID","parkID","attendance",
    ...
    "Pitching.csv": (
        "pitching",
        [
            "yearID","lgID","teamID","playerID","W","L","G","GS","CG","SHO","SV",
            "IPouts","H","ER","HR","BB","SO","BAOpp","ERA","IBB","WP","HBP","BK",
            "BFP","GF","R","SH","SF","GIDP"
        ]
    ),
    "Batting.csv": (
        "batting",
        [
            "yearID","lgID","teamID","playerID","G","AB","R","H","_2B","_3B",
...
def copy_to_staging(cur, csv_path, table):
    with open(csv_path, "r", newline="") as f:
        cur.copy_expert(
            f"COPY raw_lahman.stg_{table} FROM STDIN WITH CSV HEADER", f
        )
...
def upsert(cur, table, columns):
    ...
    int_cols = {
        ...
        "weight","height","yearID","Rank","G","Ghome","W","L","AB","H","_2B","_3B",
        "HR","BB","SO","SB","CS","HBP","SF","RA","ER","CG","SHO","SV","IPouts",
        "HAA","HA","attendance","salary","R","GIDP","GS","IBB","WP","BK","BFP","GF","SH","RBI"
    }
    ...
    cast_expressions = []
    for c in columns:
        if c in ("playerID","teamID","franchID","lgID","divID","parkID","leagueID","retroID","bbrefID"):
