...
def main():
    ...
    parser.add_argument("--year-start", type=int, default=2008, help="Start year (Statcast began in 2008)")
    parser.add_argument("--year-end", type=int, default=2026, help="End year")
    parser.add_argument("--type", choices=["batter", "pitcher", "both"], default="both", help="Data type")
