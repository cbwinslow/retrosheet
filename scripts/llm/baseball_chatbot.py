    ...
    def extract_tool_calls(self, response: str) -> List[Dict]:
        ...
        if start_idx != -1:
            ...
            if end_idx != -1:
                ...
                print(f"DEBUG: Raw extracted content: {repr(json_content)}")

                # Remove any leading/trailing whitespace and newlines
                json_content = json_content.strip()
                print(f"DEBUG: Stripped content: {repr(json_content)}")
...
This will give us the specific probabilities for this plate appearance."""
        ...
        elif "simulate" in last_message.lower():
