...
def record_download_run(conn, source_name, source_url, file_size_bytes, 
                        file_path, script_name='manual_wget', 
    ...
    try:
        ...
        """, (
            ...
            json.dumps({
                ...
                'data_types': ['event_files', 'box_scores', 'game_logs', 'biographical', 'awards', 'all_star', 'postseason', 'negro_leagues']
            })
        ))
