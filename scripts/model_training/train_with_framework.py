...
from mlb_predict import (
    ...
    ExperimentRunner, compare_model_families, compare_feature_sets,
    TrainResult,
)
...
def train_legacy_style(args: argparse.Namespace) -> TrainResult:
    ...
    """
    print(f"[INFO] Training with legacy-style arguments")
...
def run_comparison(args: argparse.Namespace) -> None:
    ...
    print(f"[INFO] Running comparison experiment")
