...
from baseball.models.base import BaseModel, ModelConfig, ModelResult, TrainingConfig
...
class BacktestEngine:
    ...
    def run(self) -> BacktestResult:
        ...
        try:
            ...
            for season_idx, (season, season_start, season_end) in enumerate(date_ranges):
                if self._cancelled:
                    break
                ...
                while current_date <= season_end and not self._cancelled:
                    ...
                    try:
                        ...
                        X_train, y_train, features = self._load_training_data(
                        ...
                        model = self.config.model_class(config=model_config)
...
def get_backtest_status(backtest_id: int) -> Optional[Dict[str, Any]]:
