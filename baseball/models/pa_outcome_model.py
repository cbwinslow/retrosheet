...
from .base import (
    SklearnBaseModel, ModelConfig, TrainingConfig, ModelType,
...
class PAOutcomeModel(SklearnBaseModel):
    ...
    def __init__(self, db_connection=None, config: Optional[ModelConfig] = None):
    ...
    def _fit_model(self, X_train: Any, y_train: Any,
    ...
    def predict_class_probabilities(self, game_state: Dict[str, Any]) -> Dict[str, float]:
        ...
        for col in self._feature_names:
            ...
            if col in ('is_high_leverage', 'is_platoon_advantage', 
                      'batter_is_hot', 'pitcher_is_hot', 'is_top_half'):
    ...
    def save_predictions(self, predictions: List[Dict[str, Any]],
                        model_version: str, season: int) -> bool:
    ...
    def get_top_predictions(self, game_states: List[Dict[str, Any]], 
