...
from baseball.betting.schemas import PlacedBet, BetOpportunity, BetOutcome
...
class PaperTradingAccount:
    ...
    def __init__(
        ...
        on_bet_settled: Optional[Callable] = None
    ):
...
class PaperTradingManager:
    ...
    def get_account(self, name: str) -> Optional[PaperTradingAccount]:
        """Get account by name."""
