...
from baseball.betting.schemas import (
    BettingMarket, BetOpportunity, MarketType,
    BetRecommendation, PlacedBet, RiskMetrics
)
...
class BettingAnalyzer:
    ...
    def __init__(
        ...
        edge_calculator: Optional[Callable[[Decimal, Decimal], Decimal]] = None,
    ...
    def analyze_game(
        ...
        for market_type in market_types:
            try:
                ...
                logger.error(f"Failed to analyze {market_type} for {game_id}: {e}")
