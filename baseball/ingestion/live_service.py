...
from baseball.ingestion.base import WebSocketIngestionSource
...
class LiveDataIngestionService:
    ...
    async def _connection_loop(
        ...
        while True:
            try:
                ...
                logger.error(f"Connection error for {feed_name}: {e}")
    ...
    async def _handle_message(self, feed_name: str, message: str) -> None:
        ...
        try:
            ...
            logger.error(f"Message handling error for {feed_name}: {e}")
    ...
    def get_stats(self, feed_name: Optional[str] = None) -> Dict:
    ...
    async def send_message(self, feed_name: str, message: Dict) -> bool:
        ...
        try:
            ...
            logger.error(f"Send failed for {feed_name}: {e}")
            return False
