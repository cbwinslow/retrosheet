...
class BaseIngestionSource(ABC):
    ...
    def off(self, event: str, handler: Optional[Callable] = None) -> 'BaseIngestionSource':
...
class WebSocketIngestionSource(BaseIngestionSource):
    ...
    def __init__(self, *args, websocket_url: str, **kwargs):
    ...
    def fetch(self, params: Dict[str, Any]) -> Any:
        ...
        raise NotImplementedError("WebSocket sources use async message handling")
