...
from .base import FeatureStore, FeatureConfig, FeatureResult, GameState
...
class LeverageIndexCalculator(FeatureStore):
    ...
    Example:
        ...
        ...     runner_1b=True, runner_3b=True,  # RISP
    ...
    def load_from_db(self, season: Optional[int] = None) -> int:
    ...
    def compute(self, game_state: GameState) -> Optional[float]:
    ...
    def get_rating(self, li: float) -> LeverageRating:
        ...
        elif li >= self.MEDIUM_THRESHOLD:
            return LeverageRating.HIGH
        elif li >= self.LOW_THRESHOLD:
    ...
    def get_clutch_opportunities(self, game_pk: int, 
