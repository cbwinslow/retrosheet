...
class ConversationManager:
    ...
    def add_user_message(self, content: str, intent: Optional[str] = None,
                        entities: Optional[List[Dict]] = None) -> None:
    ...
    def is_follow_up_question(self) -> bool:
        ...
        follow_up_indicators = [
            'they', 'them', 'their', 'he', 'she', 'him', 'his', 'her',
            'that', 'it', 'this', 'those', 'these', 'the', 'a', 'an'
        ]
