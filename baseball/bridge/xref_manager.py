...
class XrefManager:
    ...
    def find_player(self, first_name: str, last_name: str,
                    birth_date: Any | None = None) -> list[PlayerXref]:
    ...
    def find_games_by_matchup(self, team1_code: str, team2_code: str,
                              year: int | None = None) -> list[GameXref]:
