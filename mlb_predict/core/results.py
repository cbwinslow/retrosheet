...
class Metrics(BaseModel):
    ...
    pr_auc: Optional[MetricValue] = None
    ...
    f1_micro: Optional[MetricValue] = None
    f1_macro: Optional[MetricValue] = None
    f1_weighted: Optional[MetricValue] = None
    
    # Calibration metrics
    calibration_error: Optional[MetricValue] = None
    expected_calibration_error: Optional[MetricValue] = None
    max_calibration_error: Optional[MetricValue] = None
    
    # Ranking metrics
    ndcg: Optional[MetricValue] = None
    map_score: Optional[MetricValue] = None
    
    # Regression metrics (for run expectancy, win probability)
    rmse: Optional[MetricValue] = None
    mae: Optional[MetricValue] = None
    mape: Optional[MetricValue] = None
    r2: Optional[MetricValue] = None
    
    # Baseball-specific metrics
    log_likelihood: Optional[MetricValue] = None
...
class ValidationCurve(BaseModel):
    ...
    best_train_value: Optional[float] = None
    best_val_value: Optional[float] = None
...
class FeatureImportance(BaseModel):
    ...
    std: Optional[float] = None
    std_dev: Optional[float] = None  # Alias for std
...
class Residuals(BaseModel):
    ...
    residuals: Optional[List[float]] = None  # y_true - y_pred
    sample_ids: Optional[List[int]] = None
    feature_values: Optional[Dict[str, List[Any]]] = None  # For subgroup analysis
...
class TrainResult(BaseModel):
    ...
    # Error analysis
    residuals: Optional[Residuals] = None
    train_residuals: Optional[Residuals] = None
    val_residuals: Optional[Residuals] = None
    test_residuals: Optional[Residuals] = None
    ...
    def save_to_registry(self, connection_string: Optional[str] = None) -> None:
