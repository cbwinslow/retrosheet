...
class SplitConfig(BaseModel):
    ...
    test_seasons: Optional[List[int]] = Field(
        default=None,
        description="Specific seasons for test set (temporal strategy only)."
    )
    val_seasons: Optional[List[int]] = Field(
        default=None,
...
class ModelConfig(BaseModel):
    ...
    min_season: Optional[int] = Field(default=None)
    max_season: Optional[int] = Field(default=None)
    exclude_seasons: Optional[List[int]] = Field(default=None)
    ...
    sample_weight: Optional[str] = Field(
        default=None,
    ...
    def get_model_id_string(self) -> str:
        ...
        import hashlib
        data = self.model_dump(exclude={'git_commit', 'experiment_name', 'run_name', 'description', 'tags'})
...
def get_model_comparison_experiment(target: TargetVariable = TargetVariable.SWING_DECISION) -> ExperimentConfig:
