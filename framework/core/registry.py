...
from framework.core.base import BaseDataLoader, BaseFeature, BaseMetric, BaseModel, BaseTransformer
...
class Registry:
    ...
    def register(self, name: str, cls: type, metadata: dict | None = None):
...
class ModelRegistry(Registry):
    ...
    def create_model(self, name: str, config: dict | None = None) -> BaseModel:
