...
SELECT 'features.batter_prior_season_pa_summary' AS object_name, count(*) AS row_count
FROM features.batter_prior_season_pa_summary
UNION ALL
SELECT 'features.pitcher_prior_season_pa_summary', count(*)
FROM features.pitcher_prior_season_pa_summary
UNION ALL
SELECT 'features.team_prior_season_summary', count(*)
FROM features.team_prior_season_summary
UNION ALL
SELECT 'features.pa_context_prior_season_rates', count(*)
FROM features.pa_context_prior_season_rates
UNION ALL
SELECT 'features.half_inning_outcome_summary', count(*)
