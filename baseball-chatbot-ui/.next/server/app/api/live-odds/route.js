"use strict";(()=>{var e={};e.id=782,e.ids=[782],e.modules={517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3945:(e,r,t)=>{t.r(r),t.d(r,{headerHooks:()=>_,originalPathname:()=>E,patchFetch:()=>S,requestAsyncStorage:()=>d,routeModule:()=>m,serverHooks:()=>p,staticGenerationAsyncStorage:()=>l,staticGenerationBailout:()=>g});var a={};t.r(a),t.d(a,{GET:()=>u,dynamic:()=>c});var o=t(5419),n=t(9108),s=t(9678),i=t(3023);let c="force-dynamic";async function u(){try{let e=await (0,i.Cv)(`
      SELECT
        games.game_id,
        games.game_date,
