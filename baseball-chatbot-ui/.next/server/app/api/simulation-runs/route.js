"use strict";(()=>{var e={};e.id=421,e.ids=[421],e.modules={399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6976:(e,r,t)=>{t.r(r),t.d(r,{originalPathname:()=>m,patchFetch:()=>f,requestAsyncStorage:()=>p,routeModule:()=>c,serverHooks:()=>_,staticGenerationAsyncStorage:()=>d});var n={};t.r(n),t.d(n,{GET:()=>l,dynamic:()=>u});var i=t(9303),o=t(8716),s=t(670),a=t(9567);let u="force-dynamic";async function l(){try{let e=await (0,a.Cv)(`
      SELECT
        simulation_run_id,
        requested_at,
        run_name,
